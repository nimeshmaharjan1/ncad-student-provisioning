...
const systems = [
  {
    ...
    required: ["ID Number", "Course Code", "Course Description", "Course Instance Course Year", "Status", "First Name", "Last Name", "Date of Birth", "Home Mobile Phone"],
    optional: [],
  ...
  preprocess_quercus()  —  merge, clean, deduplicate, assign Type
      ...
      <section className="space-y-3">
        ...
        <div className="flex flex-wrap gap-3">
          ...
          <a href="https://github.com/anomalyco/ncad-student-provisioning" target="_blank" rel="noopener noreferrer" className="inline-flex items-center gap-1.5 rounded-lg border bg-card px-4 py-2.5 text-sm font-medium hover:bg-muted transition-colors">
            <ExternalLink className="size-4" />
            Repository
          </a>
        </div>
